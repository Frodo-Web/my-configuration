...
static const char *volumemutecmd[]  = { "/usr/bin/amixer", "-D", "pulse", "sset", "Master", "toggle", NULL };
static const char *volumeupcmd[]    = { "/usr/bin/amixer", "-D", "pulse", "sset", "Master", "5%+", NULL };
static const char *volumedowncmd[]  = { "/usr/bin/amixer", "-D", "pulse", "sset", "Master", "5%-", NULL };
static const char *togtouchpad[]   = { "touchpad", NULL };

static Key keys[] = {
	/* modifier                     key        function        argument */
	{ MODKEY,                       XK_F9,     spawn,          {.v = brightdowncmd } },
	{ MODKEY,                       XK_F10,    spawn,          {.v = brightupcmd } },
	{ 0,            XF86AudioMute,             spawn,          {.v = volumemutecmd } },
